# -*- coding: utf-8 -*-
"""
Created on Wed Jul 15 15:38:41 2020
train a UCI dataset for transfer learning on imec 4-subj dataset: plan B
@author: lwang
"""
...
from utils import get_netAcc_splitset
...
#%% use only one dimention: net-Acc
X_train = get_netAcc_splitset(X_train)
X_test  = get_netAcc_splitset(X_test)

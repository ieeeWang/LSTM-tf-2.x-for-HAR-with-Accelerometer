...
(step 1) to train a 'best-trained-model' for transfer learning on a target dataset (without labeling). 
(step 2) to use the saved 'best-trained-model' to test a target dataset.

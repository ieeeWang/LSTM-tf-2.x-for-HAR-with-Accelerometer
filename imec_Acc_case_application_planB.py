# -*- coding: utf-8 -*-
"""
Created on Wed Jul 15 16:16:35 2020
plan B
@author: lwang
"""
...
from utils import split_3Darray, get_netAcc_datalist
import pandas
...
model_name = 'LSTM_best_trained_model_netAcc_32Hz_78.h5'
best_model= keras.models.load_model(os.path.join(model_dir, model_name))

#%% predict our Acc data
netAcc_activity_list = get_netAcc_datalist(Acc_rawdata_list)
acti = 3
X_test = netAcc_activity_list[acti]
